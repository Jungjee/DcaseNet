...
def get_args():
    ...
    parser.add_argument('-DB_SED', type = str, default = '/DB/dcase2020_sed/')
    parser.add_argument('-DB_ASC', type = str, default = '/DB/dcase2020_asc/')
    parser.add_argument('-DB_TAG', type = str, default = '/DB/dcase2019_tagging/')
    ...
    #parser.add_argument('-nb_frames_SED', type = int, default = 3000)
